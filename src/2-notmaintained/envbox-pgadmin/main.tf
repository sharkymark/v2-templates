...
resource "coder_agent" "main" {
 ...
 # The following metadata blocks are optional. They are used to display
  ...
  startup_script = <<EOT
    ...
    # clone postgresql pgadmin docker compose repo and start containers
    if [ ! -d "pgadmin" ] 
    then  
      echo "Cloning git repo..."
      git clone https://github.com/sharkymark/pgadmin.git
    else
      echo "directory and repo pgadmin exists, so skipping clone"
    fi
    ...
    # resources
    # https://github.com/sharkymark/pgadmin/blob/main/docker-compose.yml
  EOT
}
