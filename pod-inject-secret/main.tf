...
data "coder_parameter" "dev_secret" {
  name        = "Developer Secret"
  description = "A fictional developer secret"
  type        = "string"
  default     = ""
  mutable     = true 
...
resource "coder_agent" "coder" {
  ...
  env                     = {
    ...
    "DEV_SECRET" = data.coder_parameter.dev_secret.value != "" ? data.coder_parameter.dev_secret.value : null }    
  startup_script = <<EOT
#!/bin/bash

# echo the developer secret
echo "The developer secret passed as an environment variable DEV_SECRET"
echo $DEV_SECRET
...
resource "coder_metadata" "workspace_info" {
  ...
  item {
    key   = "dev-secret"
    value = data.coder_parameter.dev_secret.value
    sensitive = true
  }  
}