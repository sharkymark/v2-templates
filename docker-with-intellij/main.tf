...
variable "image" {
  ...
  default     = "codercom/enterprise-intellij:ubuntu"
  validation {
    condition = contains([
...
# install jetbrains projector CLI and create intellij config
...
SERVICE_URL=https://open-vsx.org/vscode/gallery ITEM_URL=https://open-vsx.org/vscode/item code-server --install-extension redhat.java
